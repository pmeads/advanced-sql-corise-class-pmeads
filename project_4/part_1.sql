...
duplicate orders in them. This also skewed the total_spent result.  

The Lineitem table has the part key in it so there was really no reason to join 
in the part table. This may have accounted for the duplicates.  Definately 
